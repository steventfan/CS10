...
int main() {
    ...
    while ( (textInput.find("BFF") != string::npos) || (textInput.find("IDK") != string::npos) || (textInput.find("JK") != string::npos) || (textInput.find("TMI") != string::npos) || (textInput.find("TTYL") != string::npos) ) {
